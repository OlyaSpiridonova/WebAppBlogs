...
import { ArticleView, ArticleType, ArticleBlockType } from '@/entities/Article';
...
const Template: ComponentStory<typeof ArticleInfiniteList> = (args) => <ArticleInfiniteList />;
const articles = {
    articlePage: {
        isLoading: false,
        error: undefined,
...
Normal.args = {};
Normal.decorators = [StoreDecorator(articles)];
